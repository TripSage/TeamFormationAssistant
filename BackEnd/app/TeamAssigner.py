    ...
    for jobID in jobIDs:
        ...
        for employ in employee:
            ...
            if reqLanguage in employData['Languages'].tolist()[0].split(","):
                languageScore = 1
            memscore = (skillweight*skillScore)/100+(experienceWeight*expScore)/10
            +(hoursWeight*availableHours)/40+(languageWeight*languageScore)/5+(budgetWeight*hourlyRate)/100
